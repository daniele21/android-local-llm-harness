...
fun ConsumerCapabilityResult.toConsumerWire(operationId: String): ConsumerResultParcel = when (this) {
...
fun ConsumerPrepareResult.toConsumerWire(operationId: String): ConsumerResultParcel = when (this) {
...
fun ConsumerSessionResult.toConsumerWire(operationId: String, externalSessionId: String): ConsumerResultParcel = when (this) {
...
private fun WireErrorParcel.toCapabilityErrorCode(): ConsumerCapabilityErrorCode = enumTagOrNull<ConsumerCapabilityErrorCode>(code)
    ?: when (code) {
...
private fun ConsumerErrorCode.safeMessage(): String = when (this) {
