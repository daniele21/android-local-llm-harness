...
internal fun EffectiveGenerationMetadata.toWire() = EffectiveGenerationMetadataParcel(
...
internal fun EffectiveGenerationMetadataParcel.toCore() = EffectiveGenerationMetadata(
...
internal fun GenerationMetrics.toWire() = GenerationMetricsParcel(
    queueMs = queueMs,
...
internal fun GenerationMetricsParcel.toCore() = GenerationMetrics(
    queueMs = queueMs,
    modelLoadMs = modelLoadMs,
    timeToFirstTokenMs = timeToFirstTokenMs,
    totalMs = totalMs,
...
fun LocalLlmError.toSafeWire(): WireErrorParcel = when (this) {
