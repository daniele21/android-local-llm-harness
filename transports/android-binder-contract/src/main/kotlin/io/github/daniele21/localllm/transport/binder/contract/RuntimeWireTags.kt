...
internal fun ChatTemplateSource.toWireTag() =
    when (this) {
...
internal fun String.toCoreChatTemplateSource() =
    when (this) {
...
internal fun ModelLoadKind.toWireTag() =
    when (this) {
...
internal fun String.toCoreModelLoadKind() =
    when (this) {
...
internal fun StopReason.toWireTag() =
    when (this) {
...
internal fun String.toCoreStopReason() =
    when (this) {
