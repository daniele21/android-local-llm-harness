...
internal object Qwen35CuratedModelReleases {
    ...
    private fun qwenThreePointFiveZeroPointEightBQFourKM(): CatalogModelRelease =
        CuratedModelReleaseFactory.release(
    ...
    private fun qwenThreePointFiveZeroPointEightBQFiveKM(): CatalogModelRelease =
        CuratedModelReleaseFactory.release(
    ...
    private fun qwenThreePointFiveZeroPointEightBQEightZero(): CatalogModelRelease =
        CuratedModelReleaseFactory.release(
