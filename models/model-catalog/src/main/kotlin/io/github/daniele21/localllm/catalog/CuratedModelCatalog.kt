...
object CuratedModelCatalog {
    ...
    fun document(generatedAtEpochMs: Long, expiresAtEpochMs: Long): CatalogModelDocument =
    ...
    private fun qwenThreePointFiveZeroPointEightB(): CatalogModelRelease =
        release(
    ...
    private fun lfmTwoPointFiveOnePointTwoB(): CatalogModelRelease =
        release(
    ...
    private fun smolLmTwoThreeHundredSixtyM(): CatalogModelRelease =
        release(
    ...
    private fun qwenThreePointFiveTwoB(): CatalogModelRelease =
        release(
