...
| EVAL-4 Evaluation runner | IN PROGRESS | R-01 fake-driven lifecycle engine and R-02 controlled selected-model resolution are integrated; R-03 production preflight is under final replay/validation. |
...
R-01/R-02 do not claim active-decode timeout/cancellation or production dataset/evaluator/runtime wiring. P-06 does not claim P-07 per-case outcome persistence. U-02 does not claim connected Compose behavior.
