...
This ledger records a completed implementation sequence. Current repository status is owned by [`../../current-state.md`](../../current-state.md); durable behavior is routed through [`../../model-catalog-download-plan.md`](../../model-catalog-download-plan.md).

**Historical canonical plan:** [`../../model-catalog-download-plan.md`](../../model-catalog-download-plan.md)
