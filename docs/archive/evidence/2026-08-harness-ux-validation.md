...
This file records validation from an earlier implementation branch. Current validation gaps are owned by [`../../current-state.md`](../../current-state.md) and [`../../releases/harness-0.5.md`](../../releases/harness-0.5.md).
