...
This is the original comprehensive brand proposal. Current brand decisions and code-owned tokens are routed through [`../../harness-brand-guidelines.md`](../../harness-brand-guidelines.md).
