...
| Initial preset | `Balanced local PII` |

Create and enable the connection. Harnex remains the authority: the Maven dependency and Binder connection do not grant access by themselves.
...
- sessions are closed on terminal paths and the Consumer client is closed with the Activity;
