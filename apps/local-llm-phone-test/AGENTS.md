...
- Emulator-only fault/control authority remains variant-scoped and separately signature-protected; never reuse or broaden the public inference bind surface for test control.
