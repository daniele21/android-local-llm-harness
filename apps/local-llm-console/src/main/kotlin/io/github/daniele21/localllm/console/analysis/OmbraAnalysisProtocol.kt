...
internal data class OmbraAnalysisChunk(val ordinal: Int, val segments: List<OmbraAnalysisSegmentData>, val dataPayload: String) {
    init {
    ...
    override fun toString(): String = "OmbraAnalysisChunk(ordinal=$ordinal, segmentCount=${segments.size}, dataPayload=<redacted>)"
}
