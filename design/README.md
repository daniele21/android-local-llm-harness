...
- `ux-contract.json` — machine-readable product-experience expectations and critical journeys;
- `brand-kit.json` — semantic routing to the real visual/token owners;
