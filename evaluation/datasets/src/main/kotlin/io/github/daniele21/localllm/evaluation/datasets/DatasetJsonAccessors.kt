...
internal fun JsonValue.ObjectValue.requireString(name: String, lineNumber: Int): String =
    (fields[name] as? JsonValue.StringValue)?.value
        ?: datasetParseFailure(lineNumber, DatasetParseErrorCode.INVALID_FIELD)

internal fun JsonValue.ObjectValue.requireInt(name: String, lineNumber: Int): Int = (fields[name] as? JsonValue.NumberValue)?.value?.let { number ->
...
internal fun JsonValue.ObjectValue.requireObject(name: String, lineNumber: Int): JsonValue.ObjectValue = fields[name] as? JsonValue.ObjectValue
    ?: datasetParseFailure(lineNumber, DatasetParseErrorCode.INVALID_FIELD)
