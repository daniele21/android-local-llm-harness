...
class EvaluationRunPreflightTest {
    ...
    fun `unsupported model short circuits downstream checks`() = runBlocking {
        ...
        val preflight = EvaluationRunPreflight(
            ...
            datasetPreflight = EvaluationDatasetPreflight { _, _ ->
                downstreamCalled = true
                null
            },
            evaluatorPreflight = EvaluationEvaluatorPreflight { _ ->
                downstreamCalled = true
                null
            },
            executionProfilePreflight = EvaluationExecutionProfilePreflight { _, _ ->
                downstreamCalled = true
                null
            },
        )
    ...
    private fun config(): EvaluationRunConfig {
        ...
        return EvaluationRunConfig(
            ...
            executionProfile = EvaluationExecutionProfileRef(
                EvaluationExecutionProfileId("direct"),
                1,
            ),
